        ...
        <div className="flex flex-wrap gap-5 justify-between items-center">
          ...
          <div className="contact-info flex flex-wrap gap-3 ">
            <a href="https://github.com/Mahmoud-Azamtta" target="_blank">
              <div className="flex items-center transition rounded-md px-2 py-1 group dark:hover:bg-gray-300 hover:bg-gray-900">
                <svg
                  width="22px"
                  height="22px"
                  viewBox="0 0 20 20"
                ...
                <span className="ml-2 transition dark:group-hover:text-black group-hover:text-gray-300">Mahmoud-Azamtta</span>
              </div>
            </a>
            <a href="https://www.instagram.com/m7mod.az/" target="_blank">
              <div className="flex items-center transition rounded-md px-2 py-1 group dark:hover:bg-gray-300 hover:bg-gray-900">
                ...
                <span className="ml-2 transition dark:group-hover:text-black group-hover:text-gray-300">m7mod.az</span>
              </div>
            </a>
